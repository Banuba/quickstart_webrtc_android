(function (exports) {
  ...
  ***************************************************************************** */
  ...
  var Video = /*@__PURE__*/ (function () {
      ...
      Video.prototype.setSpeedFactor = function (speedFactor) {
          this._speedFactor = speedFactor;
          return this;
      };
  ...
  var mesh$b = "tri_transparent.bsm2";
  ...
  var BackgroundTranparent = /*@__PURE__*/ (function () {
      ...
      /** Enables the transparent background */
      BackgroundTranparent.prototype.enable = function () {
          this._mesh.enable();
          return this;
      };
      /** Sets transparency value for background behind a body */
      BackgroundTranparent.prototype.setTransparency = function (value) {
          this._transparency.set(value);
          return this;
      };
      /** Disables the transparent background */
      BackgroundTranparent.prototype.disable = function () {
          this._mesh.disable();
          return this;
      };
      __decorate([
          json
      ], BackgroundTranparent.prototype, "enable", null);
      __decorate([
          json
      ], BackgroundTranparent.prototype, "setTransparency", null);
      return BackgroundTranparent;
  }());
  /** Global BackgroundTransparency instance */
  var backgroundTranparent = /*@__PURE__*/ new BackgroundTranparent();
  ...
  var BackgroundBlur = /*@__PURE__*/ (function () {
      ...
      /** Sets background blur radius in [0.,1.], where 0. - min, 1. - max value */
      BackgroundBlur.prototype.setRadius = function (value) {
          this._radius.set(value * 10); // because real range is [0.,10.]
          return this;
      };
  ...
  var js_hair_colors$1 = [21,22,23,24,25,26,27,28];
  var js_hair_colors_size = 29;
  ...
  var js_hair_colors = [21,22,23,24,25,26,27,28];
  ...
  var js_strand_colors = [30,31,32,33,34];
  ...
  var js_lips_color$1 = 36;
  var js_lips_brightness_contrast = 37;
  ...
  var MattLips = /*@__PURE__*/ (function () {
    function MattLips() {
        ...
        this._mesh = new Mesh(mesh$3)
            .on("enabled", function () {
            recognizer.enable("lips_segmentation");
            faceTracker // TODO: The `lips` works bad without face tracker
                .on("face", _this._enable)
                .on("no-face", _this._disable);
        })
            .on("disabled", function () {
            recognizer.disable("lips_segmentation");
            faceTracker
  ...
  var js_lips_color = 36;
  var js_lips_shine = 38;
  var js_lips_glitter = 39;

  var defaultShineParams = "1.5 1 0.5 1";
  var defaultGlitterParams = "0 0 0 1";
  ...
  var ShinyLips = /*@__PURE__*/ (function () {
    function ShinyLips() {
        ...
        this._mesh = new Mesh(mesh$1)
            .on("enabled", function () {
            recognizer.enable("lips_shine");
            faceTracker // TODO: The `lips_shine` works bad without face tracker
                .on("face", _this._enable)
                .on("no-face", _this._disable);
        })
            .on("disabled", function () {
            recognizer.disable("lips_shine");
            faceTracker
                .off("face", _this._enable)
                .off("no-face", _this._disable);
        });
       ...
       * @property glitter.w - shiny area scale
       */
      ...
      ShinyLips.prototype.shineScale = function (value) {
          this._glitter.w.set(value);
          return this;
      };
      ...
      __decorate([
          json
      ], ShinyLips.prototype, "shineScale", null);
      __decorate([
          json
  ...
  var Lips = /*@__PURE__*/ (function () {
      function Lips() {
          ...
          this._features = {
              ...
              shineScale: this._lips === mattLips ? 0 : 1,
      ...
      Lips.prototype.shineScale = function (value) {
          return this._setFeature("shineScale", value);
      };
  ...
  exports.BackgroundTranparent = backgroundTranparent;
...
function initTransparentBG(params) {
    BackgroundTranparent.enable()
}

function deleteTransparentBG(params) {
    BackgroundTranparent.disable()
}
...
function onDataUpdate(param) {
    ...
    if (typeof (value) == "object") {
        ...
        FaceMorph.eyes(beautifyingProps.morph_eyes_str);
        FaceMorph.face(beautifyingProps.morph_cheeks_str);
        FaceMorph.nose(beautifyingProps.morph_nose_str);

        SkinSoftening.strength(beautifyingProps.skin_soft_str);
        Softlight.strength(beautifyingProps.softlight_alpha);
        EyesWhitening.strength(beautifyingProps.eyes_coloring_str);
        TeethWhitening.strength(beautifyingProps.teeth_whitening_str);
    } else {
        ...
        EyesWhitening.strength(value);
        TeethWhitening.strength(value);
    }
}
